...
const scheduleBase = "/istanbul-cruise-ship-schedule";
...
const dynamicPatterns = [
  /^\/shore-excursions\/[\w-]+$/,
  /^\/istanbul-cruise-ship-schedule\/(2026|2027)$/,
  /^\/istanbul-cruise-ship-schedule\/(january|february|march|april|may|june|july|august|september|october|november|december)-20(26|27)$/,
];
