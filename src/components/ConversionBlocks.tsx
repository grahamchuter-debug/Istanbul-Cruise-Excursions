  ...
  return (
    <div className="card-accent mt-10 flex flex-wrap items-center justify-between gap-4">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600">We match Istanbul shore excursions to your port window with honest return-to-ship advice across Europe and Asia.</p>
      </div>
