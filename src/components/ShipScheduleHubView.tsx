  ...
  return (
    <>
      ...
      {!hasData && (
        <div className="mb-8 rounded-xl border border-amber-200 bg-amber-50 p-6">
          ...
          <p className="mt-2 text-sm text-amber-900">
            ...
            <Link href="/istanbul-cruise-port-guide" className="font-medium underline">
              cruise port guide
            </Link>{" "}
            for planning.
          </p>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        <Link href="/istanbul-cruise-planner" className="btn-secondary text-sm">Cruise Planner</Link>
      </div>
    </>
  );
}
